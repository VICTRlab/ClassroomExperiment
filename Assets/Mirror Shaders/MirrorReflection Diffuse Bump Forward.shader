...
/////// Diffuse:
                ...
                float2 node_1007 = float2(sceneUVs.r,(1.0 - sceneUVs.g));
                float4 _ReflectionTex_var = tex2D(_ReflectionTex,TRANSFORM_TEX(node_1007, _ReflectionTex));
